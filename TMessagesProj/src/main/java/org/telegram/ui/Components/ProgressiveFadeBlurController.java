...
public class ProgressiveFadeBlurController {
    ...
    public void invalidate() {
        ...
        final float topFraction = fadeZoneTop - topOffset > AndroidUtilities.dp(48) ? Math.min(1f, (fadeZoneTop - topOffset - AndroidUtilities.dp(48)) / (float) fh) : 1f;
