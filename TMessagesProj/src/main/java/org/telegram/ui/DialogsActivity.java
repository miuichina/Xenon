    ...
    private class ContentView extends SizeNotifierFrameLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            if (progressiveFadeController != null) {
                progressiveFadeController.setFadeZoneTop(top + actionBarHeight);
...
//            }
    ...
    public View createView(final Context context) {
        ...
        //}
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU && NekoConfig.progressiveFadeBlurOtherActivities) {
            progressiveFadeController = new ProgressiveFadeBlurController(contentView, viewPages[0], contentView.indexOfChild(actionBar));
